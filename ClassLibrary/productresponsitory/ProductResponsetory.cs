...
{
    public class ProductResponsetory<T>: IProductResponsetory<T> where T : class
    {
        protected readonly DataContextProduct m_context;
        protected DbSet<T> m_table = null;
        public ProductResponsetory(DataContextProduct context)
        {
            m_context = context;
